...
# ------------------------------------------------------------------------
select "";
select "students whose names end in 'ori' with one letter prceeding";
...
# ------------------------------------------------------------------------
select "";
select "students whose names have 'ori' with one letter preceeding";
...
# ------------------------------------------------------------------------
select "";
select "applications with majors that have at least two 'i's";
...
# ------------------------------------------------------------------------
select "";
select "five best students by GPA";
...
# ------------------------------------------------------------------------
select "";
select "3rd, 4th, and 5th best students by GPA";
